...
\f0\fs24 \cf0 === Google News Editors Picks Feed Generator ===\
...
\
Plugin generates not one but two, highly customizable Google News Editors\'92 Picks RSS Feeds. Increase your news site traffic with featured content on Google News!\
\
== Description ==\
\
The most comprehensive RSS feed generator specifically tailored to meet the needs of publishers wanting to optimize an individual Google News Editors\'92 Picks RSS Feed. Creates both a homepage and section-based feed topic-specific. \
...
* Add required image or logo to Google News Editors\'92 Picks RSS Feeds\
...
* Submit and set Editors\'92 Picks feeds to Google Webmaster Tools\
\
Premium features:\
\
* Set default values and customize RSS feeds\
...
* Submit and set XML News Sitemap and Editors\'92 Picks feeds to Google Webmaster Tools\
\
...
8. Configure the feed settings under Google News > Editors\'92 Picks, otherwise you will get errors in Google Webmaster Tools.\
...
12. Return to Google News > Editors\'92 Picks and submit the newly created Google News Editors\'92 Picks RSS Feeds in Google Webmaster Tools via "Submit RSS Feeds".\
\
== Screenshots ==\
\
...
== FAQs ==\
\
<strong>Why are my custom Google News Editors\'92 Picks RSS feeds giving me a 404 error?</strong>\
\
If no feed appears when you click on the \'93View RSS Feed\'94 button, which will give you a 404 error, then go to \'93Permalinks\'94 under \'93Settings\'94 in the left-hand side WP column, and click \'93Save Settings\'94 to generate your custom RSS feeds. Return to the Editors\'92 Picks admin page and once again click on the \'93View RSS Feed\'94 button. You will now see your feed.\
\
For more information on how to set up your custom Editors\'92 Picks, read the [following feed tutorial](http://bit.ly/YMGVof).\
\
== Changelog ==\
\
Version 1.0\
