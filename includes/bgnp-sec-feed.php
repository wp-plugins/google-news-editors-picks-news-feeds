<?php
/*********************************************************
 * Create (Section-Based) Editors' Picks RSS Feed Template
 ********************************************************/
...
>
<channel>
	<title><?php echo $bgnp_sec_feed_title; ?></title>
	<atom:link href="<?php self_link(); ?>" rel="self" type="application/rss+xml" />
	<link><?php echo get_bloginfo( 'url' ) ?></link>
	<description><?php echo $bgnp_sec_feed_desc; ?></description>
	<image>
		<url><?php echo $bgnp_sec_image_url; ?></url>
		<title><?php echo $bgnp_sec_image_alt; ?></title>
		<link><?php echo get_bloginfo( 'url' ) ?></link>
 	</image>
